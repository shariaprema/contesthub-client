                    ...
                    <div className='text-white   pl-16 lg:w-1/2 md:w-3/5 sm:w-1/4 sm:flex-wrap text-ellipsis overflow-hidden'>
                        ...
                        <form>   
                            ...
                            <div className="relative">
                                ...
                                <button type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-orange-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                            </div>
                        </form>
